...
const cars = [
  { x: -100, y: 260, width: 80, height: 35, speed: 3, direction: 1 },
  { x: 200, y: 260, width: 80, height: 35, speed: 3, direction: 1 },

  { x: 650, y: 310, width: 80, height: 35, speed: 4, direction: -1 },
  { x: 350, y: 310, width: 80, height: 35, speed: 4, direction: -1 },

  { x: -200, y: 360, width: 80, height: 35, speed: 2.5, direction: 1 },
  { x: 150, y: 360, width: 80, height: 35, speed: 2.5, direction: 1 }
];
...
function drawCars() {
  for (let car of cars) {
    ...
    ctx.fillRect(car.x + 15, car.y + 5, 20, 12);
    ctx.fillRect(car.x + 45, car.y + 5, 20, 12);

    // Wheels
    ctx.fillStyle = "black";
    ctx.beginPath();
    ctx.arc(car.x + 15, car.y + 35, 5, 0, Math.PI * 2);
    ctx.fill();

    ctx.beginPath();
    ctx.arc(car.x + 65, car.y + 35, 5, 0, Math.PI * 2);
    ctx.fill();
  }
}
